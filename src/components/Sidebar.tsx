...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, onLogout, onOpenBusinessProfile }) => {
  ...
  return (
    <div className="w-72 bg-brand-700 text-brand-100 dark:bg-slate-950/95 dark:text-slate-300 h-screen flex flex-col fixed left-0 top-0 z-50 border-r border-brand-600/40 dark:border-slate-800 shadow-2xl dark:shadow-black/30 overflow-y-auto custom-scrollbar backdrop-blur-xl">
      <div className="p-8">
